...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(() -> Math.abs(m_controller.getRightTriggerAxis()) > 0.2).whileTrue(new MoveElevator(m_elevator, m_controller.getRightTriggerAxis() * 0.2));
    new Trigger(() -> Math.abs(m_controller.getLeftTriggerAxis()) > 0.2).whileTrue(new MoveElevator(m_elevator, m_controller.getLeftTriggerAxis() * -0.2));
  }
